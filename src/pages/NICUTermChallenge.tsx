...
const nicuTerms: TermData[] = [
  { word: 'LATCH', definition: 'How baby attaches to breast or bottle for feeding', hint: 'Feeding attachment (5 letters)' },
  { word: 'SWADDLE', definition: 'Wrapping baby snugly in a blanket for comfort', hint: 'Wrapping baby (7 letters)' },
  { word: 'PROBE', definition: 'Sensor that measures vital signs', hint: 'Monitoring sensor (5 letters)' },
  { word: 'GROWTH', definition: 'Increase in weight, length, and head size', hint: 'Baby getting bigger (6 letters)' },
  { word: 'DONOR', definition: 'Breast milk from another mother', hint: 'Donated milk (5 letters)' },
  { word: 'NURSE', definition: 'Healthcare provider caring for your baby', hint: 'Primary caregiver (5 letters)' },
  { word: 'BRAIN', definition: 'Organ that controls all body functions', hint: 'Thinking organ (5 letters)' },
  { word: 'TOUCH', definition: 'Gentle contact that comforts and bonds', hint: 'Gentle contact (5 letters)' },
  { word: 'FEEDS', definition: 'Meals given to baby throughout the day', hint: 'Baby meals (5 letters)' },
  { word: 'CUES', definition: 'Baby\'s signals about hunger or discomfort', hint: 'Baby signals (4 letters)' },
  { word: 'WEIGHT', definition: 'How heavy your baby is, tracked daily', hint: 'Daily measurement (6 letters)' },
  { word: 'APNEA', definition: 'A pause in breathing lasting more than 20 seconds', hint: 'Breathing pause (5 letters)' },
  { word: 'APGAR', definition: 'Score measuring baby\'s health at birth', hint: 'Birth health score (5 letters)' },
  { word: 'LUNGS', definition: 'Organs that help baby breathe', hint: 'Breathing organs (5 letters)' },
  { word: 'HEART', definition: 'Organ that pumps blood throughout body', hint: 'Pumping organ (5 letters)' },
  { word: 'DESAT', definition: 'Drop in oxygen saturation levels', hint: 'Oxygen level drop (5 letters)' },
  { word: 'BRADY', definition: 'Short for bradycardia - slow heart rate', hint: 'Slow heartbeat (5 letters)' },
  { word: 'LEADS', definition: 'Wires connecting baby to monitors', hint: 'Monitor wires (5 letters)' },
  { word: 'INFECTION', definition: 'Illness caused by germs entering the body', hint: 'Illness from germs (9 letters)' },
  { word: 'HUMIDITY', definition: 'Moisture level in isolette air', hint: 'Moisture in air (8 letters)' },
  ...
  { word: 'GAVAGE', definition: 'Tube feeding through nose or mouth', hint: 'Tube feeding (6 letters)' },
  { word: 'INTUBATE', definition: 'Placing a breathing tube in airway', hint: 'Inserting breathing tube (8 letters)' },
  { word: 'CALORIES', definition: 'Energy units in milk or formula', hint: 'Food energy units (8 letters)' },
  ...
  { word: 'OXYGEN', definition: 'Gas needed for breathing and survival', hint: 'Breathing gas (6 letters)' },
  { word: 'MONITOR', definition: 'Screen showing vital signs continuously', hint: 'Vital signs screen (7 letters)' },
  { word: 'SUCTION', definition: 'Removing secretions from mouth or nose', hint: 'Clearing airways (7 letters)' },
  { word: 'CAFFEINE', definition: 'Medication to help with breathing pauses', hint: 'Breathing medication (8 letters)' },
  { word: 'MILK', definition: 'Breast milk or formula for feeding', hint: 'Baby\'s drink (4 letters)' },
  { word: 'BILI', definition: 'Short for bilirubin - causes jaundice', hint: 'Jaundice cause (4 letters)' },
  { word: 'SEPSIS', definition: 'Serious infection in the bloodstream', hint: 'Blood infection (6 letters)' },
  { word: 'NASAL', definition: 'Through the nose (as in nasal cannula)', hint: 'Through the nose (5 letters)' },
  { word: 'PUMP', definition: 'Device to express breast milk', hint: 'Milk expression device (4 letters)' }
]

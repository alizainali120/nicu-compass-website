...
const NICUBasicsGuide: React.FC = () => (
  <div className="nicu-guide-page-bg section-padding">
    <div className="container-padding">
      <h1 className="nicu-guide-title text-4xl sm:text-5xl font-bold mb-12 text-primary-700">
        NICU Essentials Guide
      </h1>

      <div className="nicu-guide-content max-w-5xl mx-auto">
        <article className="card p-8 sm:p-10 mb-8">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-primary-700 border-b border-primary-100 pb-4">

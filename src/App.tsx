...
import RetinopathyOfPrematurity from './pages/RetinopathyOfPrematurity'
...
import MatchTheNICUTerm from './pages/MatchTheNICUTerm'
...
import NICUDischargeChecklist from './pages/NICUDischargeChecklist'
  ...
  return (
    <Router basename={import.meta.env.BASE_URL}>
      ...
      <Routes>
        ...
        <Route path="/retinopathy-of-prematurity" element={<RetinopathyOfPrematurity />} />
        ...
        <Route path="/nicu-discharge-checklist" element={<NICUDischargeChecklist />} />
